...
public class GongjiController {
	...
	@PostMapping("/add")
	public ResponseEntity<?> addgongji( GongjiVO vo){
			gongjiService.add(vo);
			return ResponseEntity.ok().body("ok");
		
	}
	
	@GetMapping("/delete")
	public void delgongji(@RequestParam("num")int num) {
		gongjiService.delete(num);
	}
	@GetMapping("/detail")
	public GongjiVO detail(@RequestParam("num")int num) {
		return gongjiService.detail(num);
	}
	@RequestMapping("/list")
	public Map<String, Object> BoaradList(@RequestParam Map<String, String> paramMap, HttpServletRequest req){
		...
		int totalCnt = gongjiService.totalCount(paramMap);
		...
		List<GongjiVO> list = gongjiService.glist(map);
